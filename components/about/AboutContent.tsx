...
export default function AboutContent() {
  return (
    <div>
      ...
      <p className="mt-6 text-[color:var(--text-secondary)] leading-8">
      ...
      <button className="mt-8 inline-flex items-center gap-2 rounded-xl border border-theme px-6 py-3 text-[color:var(--text-primary)] transition hover:border-cyan-500 hover:bg-cyan-500/10">
        More About Me
        <ArrowRight size={18} />
      </button>
    </div>
